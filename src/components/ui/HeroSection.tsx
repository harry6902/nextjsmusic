...
function HeroSection() {
  return (
    <div className='text-white h-auto md:h-[40rem] w-full rouned-md flex flex-col items-center justify-center
    relative overflow-hidden py-10 md:py-0 '>
      ...
      />
        ...
        bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to to-neutral-400'
